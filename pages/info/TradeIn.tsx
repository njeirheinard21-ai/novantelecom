  ...
  return (
    <div className="py-24 min-h-[60vh] bg-canvas-secondary/30">
      ...
      <Container className="max-w-3xl">
        <h1 className="text-4xl md:text-5xl font-semibold tracking-tight mb-8">Trade In</h1>
        ...
        <div className="bg-canvas border border-border/50 rounded-[2rem] p-8 md:p-12 shadow-sm">
          ...
          <div className="space-y-6 text-fg/80 leading-relaxed">
            <p>
              We are working to bring you the best possible experience. Check back soon for more details regarding our trade in policies and options.
            </p>
            <p>
