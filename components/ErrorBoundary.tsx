    ...
    if (this.state.hasError) {
      return (
        <div className="flex flex-col items-center justify-center min-h-dvh p-4 bg-canvas text-fg">
          <h1 className="text-2xl font-display font-semibold mb-4 text-brand-primary">Something went wrong</h1>
          <p className="text-fg-muted mb-6">An unexpected error occurred.</p>
          <button 
